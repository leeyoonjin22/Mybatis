        ...
        <div class="joinmain">
            <div class="body2">
                ...
                <div class="join3">
                    ...
                    <div class="join3-2">
                        <table>
                            <tr>
                                ...
                                <td class="jointd"><form:input type="text" path="name" name="name" class="joinid"/></td>                                
                             </tr>
                             <tr>
                            ...
                            <tr>
                                ...
                                <td class="jointd">${user.userid}<form:input path="userid" name="userid" class="joinid"/></td>                                    
                             </tr>
                             <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <span>
                                        <input path="sex" type="radio" id="sex" name="sex" value="남성" />
                                        <label for="male1" style="">남자</label>
                                    </span>
                                    <span>
                                        <input path="sex" type="radio" id="sex" name="sex" value="여성" checked="checked" />
                    ...
                    <div class="join3-3">
						<div class="finbtn1-1">
                        <input type="submit" class="finbtn1-2" value="완료"/></div>
                        <div class="finbtn2-1"><a class="finbtn2-2" href="home">취소</a></div>
                    </div>
                    </form:form>
                </div>
            </div>
